-- Restore Production Data to Neon Database
-- Paste this ENTIRE file into Neon SQL Editor

-- ============================================================
-- USERS TABLE (from dump file)
-- ============================================================
...
INSERT INTO public.users (
    ...
    avatar, bio, phone, location, website, social_links, 
    points_balance, subscription, subscription_status, 
    ...
    0, 'free', 'inactive', NULL, NULL, NULL, NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS user_email_idx ON public.users USING btree (email);

-- ============================================================
-- NOTE: The dump file ONLY contains the users table.
-- Contests, giveaways, and other production data are NOT in this dump.
-- ============================================================
